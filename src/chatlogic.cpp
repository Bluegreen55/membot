...
ChatLogic::ChatLogic()
{
    ...
    // std::cout<<"HELLO: "<< _chatBot<<std::endl; 
    // add pointer to chatlogic so that chatbot answers can be passed on to the GUI
    _chatBot->SetChatLogicHandle(this);
  //   std::cout<<" the contents of _chatBot"<< _chatBot<<std::endl;
    ////
    //// EOF STUDENT CODE
}
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*childNode)->GraphNode::AddEdgeToParentNode(edge.get());
                            (*parentNode)->GraphNode::AddEdgeToChildNode(std::move(edge));
                        }
                        ////
                        //// EOF STUDENT CODE
                    }
